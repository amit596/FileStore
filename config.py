...
APP_ID = int(os.environ.get("APP_ID", "29171167")) #Your API ID from my.telegram.org
...
#--------------------------------------------
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://for:for@cluster0.fgu4b.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
#--------------------------------------------
START_PIC = os.environ.get("START_PIC", "https://i.ibb.co/MDszpt9d/photo-2025-09-03-01-37-53-7545671263151194120.jpg")
FORCE_PIC = os.environ.get("FORCE_PIC", "https://envs.sh/em9.jpg")

#--------------------------------------------
SHORTLINK_URL = os.environ.get("SHORTLINK_URL", "papajiurl.com")
SHORTLINK_API = os.environ.get("SHORTLINK_API", "ef0b2771c0566718523c43928b4119fdfff25c8a")
VERIFY_EXPIRE = int(os.environ.get('VERIFY_EXPIRE', 28800)) # Add time in seconds
TUT_VID = os.environ.get("TUT_VID","https://t.me/how_to_open_link_ak/25")
